							...
							<div className='flex flex-wrap items-center justify-between gap-6 md:py-3 md:gap-0'>
								<div className='w-full px-6 flex justify-between lg:w-max md:px-0'>
									<Link
										...
										<img
											src='/logo.png'
											className='h-50 w-20 block lg:hidden'
											alt=''
										/>
										<img
											src='/Updated LogoDesktop.png'
											className='h-20 w-48 hidden lg:block'
											alt=''
										/>
										'
									</Link>
									<label
										...
										htmlFor='hbr'
										className='peer-checked:hamburger
							...
							<div className='md:-mr-32'>
								<form action='' className='w-full mt-12'>
									<div className='relative flex items-center p-1 rounded-full bg-white border border-sky-200 shadow-md md:p-2'>
										<div className='sm:pl-3 pl-6 py-3'>
											<svg
										...
										<input
											...
											className='w-full p-4 rounded-full placeholder-gray-600'
											type='email'
										/>
										<button
											type='button'
