			...
			<div class='min-w-screen min-h-screen bg-blue-100 flex items-center p-5 lg:p-20 overflow-hidden relative'>
				<div class='flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left'>
					<div class='w-full md:w-1/2'>
						<div class='mb-10 lg:mb-20 flex md:block justify-center'>
							<img
								src='/logo.png'
								className='h-auto w-auto z-10 block lg:hidden'
								alt=''
							/>
							<img
								src='/Updated LogoDesktop.png'
								className='h-auto w-52 hidden lg:block'
								alt=''
							/>
						</div>
						<div class='mb-10 md:mb-20 text-gray-600 font-light'>
							...
							<p>
								Try searching again or use the Go Back button
								below.
							</p>
						</div>
						<div class='mb-20 md:mb-0'>
							<button class='text-lg font-light flex outline-none focus:outline-none transform transition-all hover:scale-110 text-yellow-500 hover:text-yellow-600'>
